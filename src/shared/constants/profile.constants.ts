...
export const SKILL_CATEGORIES = [
  ...
  { label: 'Frameworks', skills: ['Vite', 'Next.js', 'Redux Toolkit', 'React Query', 'React Router'] },
  { label: 'UI', skills: ['Material UI', 'SASS/CSS', 'Styled Components', 'Tailwind CSS'] },
  ...
  { label: 'Other', skills: ['Lexical', 'DnD Kit', 'AWS Cognito', 'OIDC', 'WebAuthn', 'ReactFlow'] },
] as const;
